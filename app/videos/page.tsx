    ...
    <div className={`min-h-screen bg-[#f8f9fa] dark:bg-gray-950 ${language === "ar" ? "rtl" : "ltr"}`}>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-5 sm:mb-12">
          <h1 className="text-2xl sm:text-4xl font-bold text-[#084f5a] dark:text-white mb-2 sm:mb-4">{t.educationalVideos}</h1>
          <p className="text-sm sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto hidden sm:block">{t.educationalVideosDesc}</p>
        </motion.div>
